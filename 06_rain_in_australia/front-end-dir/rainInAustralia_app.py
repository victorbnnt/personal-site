...
st.set_page_config(page_title='Rain in Australia',
                   page_icon=fav,
                   layout="centered",
                   initial_sidebar_state="auto",
                   menu_items={'Get Help': None,
                               'Report a bug': None,
                               'About': "# Rain in Australia"
                               })
...
url = f"http://localhost:80/predict_rain?Humidity3pm={humidity3pm}&WindGustSpeed={windgustspeed}&Location={Location}&Pressure9am={pressure9am}&MinTemp={mintemp}"
